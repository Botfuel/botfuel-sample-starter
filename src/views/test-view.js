...
const messages = [
  ...
  new ActionsMessage([
    ...
    new Postback('Buy', { name: 'name', data: { messageEntities: [{ dim: 'product', values: [{ value: 'Addidas' }] }] } }),
  ]),
  ...
  new CardsMessage([
    ...
    new Card(
      ...
      [
        new Link('Details', 'https://www.google.fr/'),
        new Postback('Buy', { name: 'name', data: { messageEntities: [{ dim: 'product', values: [{ value: 'New balance' }] }] } }),
      ],
    ),
    new Card(
      'Nike sneakers',
      ...
      [
        new Link('Details', 'https://www.google.fr/'),
        new Postback('Buy', { name: 'name', data: { messageEntities: [{ dim: 'product', values: [{ value: 'Nike' }] }] } }),
      ],
    ),
  ]),
